...
class easy_game:
    ...
    def to_stats(self):
        ...
        hintsused = float(Hints_Used)
        rounds_played = self.rounds_played.get()
        rounds_won = self.rounds_won.get()
        stats_bundle = [rounds_won, self.all_scores_list,
                        self.all_high_score_list,rounds_played,hintsused]
...
class DisplayHints:
    ...
    def __init__(self, partner,rounds_played):
        ...
        help_text = (f"This is the hints Page below this text will be "
                     ...
                     f"So Far You Have Used {Hints_Used} Hints")
...
class Stats:
    ...
    def __init__(self, partner, all_stats_info):
        ...
        hint_string = (f"You have used {Hints_Used} hints.")
