...
class Converter:
    ...
    def __init__(self):
        ...
        instructions = ("Please enter a temperature below and then press one of the "
                        "buttons to convert ut from centigrade "
                        "to fahrenheit.")
    ...
    def check_temp(self,min_temp):
        ...
        either invokes calculation function or shows a custom error
        """
        ...
        # checks that among to e converted is a number above absolute zero
        try:
    ...
    def convert(self,min_temp, to_convert):
        """
        converts temp and updates answer label also stores
        Calculations for export and history feature
        """
        ...
        # enable history export button AS SOoon as we have a valid calculation
