    ...
    def check_rounds(self):
        ...
        try:
            ...
            if rounds_wanted > 0:
                ...
                self.choose_label.config(text="hpw many rounds do you want to play?")

                # invijes play class and take across number of rounds
                Play(rounds_wanted)
                # hide root window (hide the rounds choice window )
                root.withdraw()
...
class Play:
    ...
    def new_round(self):
        ...
        # add median and high scorre to listsd for stats
    ...
    def round_results(self, user_choice):
        ...
        #printing are ti generate test data for stats
        print("all scores", self.all_scores_list)
        print("all median", self.all_medians_list)
